function Isosurfaces( volume, isovalue, screen )
{
    ...
    {
        var slices_1 = volume.resolution.x;
        var slices_2 = volume.resolution.x*volume.resolution.y;

        var x0 = v0.x + v0.y*slices_1 + v0.z*slices_2;
        var x1 = v1.x + v1.y*slices_1 + v1.z*slices_2;

        var s0 = volume.values[x0][0];
        var s1 = volume.values[x1][0];
