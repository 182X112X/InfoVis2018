        ...
        for ( var y = 0; y < volume.resolution.y - 1; y++ )
        {
            for ( var x = 0; x < volume.resolution.x - 1; x++ )
            {
                ...
                for ( var j = 0; lut.edgeID[index][j] != -1; j += 3 )
                {
                    ...
                    var eid3 = lut.edgeID[index][j+3]; //add
                    ...
                    var vid6 = lut.vertexID[eid3][0]; //add
                    var vid7 = lut.vertexID[eid3][1]; //add
                    ...
                    var v6 = new THREE.Vector3( x + vid6[0], y + vid6[1], z + vid6[2] ); //add
                    var v7 = new THREE.Vector3( x + vid7[0], y + vid7[1], z + vid7[2] ); //add
                    ...
                    var v67 = interpolated_vertex( v6, v7, isovalue ); //add

                    geometry.vertices.push( v01 );
                    geometry.vertices.push( v23 );
                    geometry.vertices.push( v45 );
                    geometry.vertices.push( v67 ); //add
                    ...
                    //geometry.faces.push( new THREE.Face3( id3, id4, id5 ) );
                }
            }
            cell_index++;
        }
