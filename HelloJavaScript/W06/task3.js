function main()
{
    ...
    fragmentShader: document.getElementById('gouraud_blinn.frag').text,
    uniforms: {
    ...
    vertexColors: THREE.VertexColors,
    vertexShader: document.getElementById('phong_blinn.vert').text,
    ...
    renderer.setViewport(0.1*screen_width, 0.2*screen_height, 0.7*width, 0.5*screen_height);
        renderer.render(scene, camera_left);

    renderer.setViewport(0.6*screen_width, 0.2*screen_height, 0.7*width, 0.5*screen_height);
